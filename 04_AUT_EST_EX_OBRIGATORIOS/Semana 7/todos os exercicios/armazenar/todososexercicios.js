...
//muda para a pagina do exercicio 1
...
//muda a pagina para o exercicio 2
...
//muda a pagina para o exercicio 3
function exercicio3(){
    document.getElementById("home").style.display="none";
    document.getElementById("exercicio1").style.display="none";
    document.getElementById("exercicio2").style.display="none";
...
//muda a pagina para o exercicio 4
function exercicio4(){
    document.getElementById("home").style.display="none";
    document.getElementById("exercicio1").style.display="none";
    document.getElementById("exercicio2").style.display="none";
...
//muda a pagina para o exercicio 5
function exercicio5(){
    document.getElementById("home").style.display="none";
    document.getElementById("exercicio1").style.display="none";
    document.getElementById("exercicio2").style.display="none";
